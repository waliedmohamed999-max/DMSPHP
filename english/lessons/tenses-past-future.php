...
<div class="output-box">✅ I worked on this project yesterday. (خلص)
✅ She wrote three emails this morning. (خلص)
✅ We went to the meeting at 10 AM. (خلص، لحظة محددة)</div>
...
<div class="output-box">✅ I was coding when the internet went down.
    (كنت بكتب كود، وفجأة قُطع النت — الحدث الأطول مستمر، الأقصر قاطعه)
✅ They were testing the app at 9 PM last night.
✅ While she was reviewing the code, she found a bug.</div>
<h3>❌ خطأ شائع / Common mistake</h3>
<div class="output-box">❌ "I coded when the internet went down." (الاتنين بالبسيط، مش واضح إيه اللي كان مستمر)</div>
<h3>✅ الصح / Correct</h3>
<div class="output-box">✅ I was coding when the internet went down.
...
<div class="output-box">will (قرار لحظي / توقع عام):
  "The phone is ringing — I'll answer it." (قرار في اللحظة)
  "I think it will rain tomorrow." (توقع)

going to (خطة اتقررت قبل كده):
  "I'm going to start a new course next month." (اتقررت بالفعل)
  "We're going to launch the app in June."

Present Continuous (موعد مؤكد ومرتب):
  "I'm meeting the client at 3 PM tomorrow." (موعد في الأجندة فعلًا)
  "We're presenting the demo on Friday."</div>
<div class="bi-block">
