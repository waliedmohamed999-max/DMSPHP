...
$page_title = 'أساسيات البرمجة — لوحة الدروس';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار أساسيات البرمجة</h1>
<p class="subtitle"><span class="ltr">Programming Fundamentals</span> — المسار الكامل للتأسيس في تعلم البرمجة قبل ما تختار مجالك الوظيفي. لا تحتاج لأي خبرة سابقة، وكل حاجة بالتنفيذ الفعلي.</p>
