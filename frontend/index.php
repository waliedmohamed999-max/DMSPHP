...
$page_title = 'Front-End Developer — لوحة الدروس';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار Front-End Developer</h1>
<p class="subtitle">المسار الكامل لاحتراف مجال الـ Front-End: HTML, CSS, JavaScript، وصولاً لأطر العمل الحديثة. تأكد إنك خلّصت كل مرحلة كويس قبل ما تروح للي بعدها.</p>
