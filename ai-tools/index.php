...
$page_title = 'أدوات الذكاء الاصطناعي — Sila';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار أدوات الذكاء الاصطناعي</h1>
<p class="subtitle"><span class="ltr">AI Tools for Learning & Development</span> — أربع أدوات ذكاء اصطناعي كل واحدة بأسلوبها الخاص، تعرف تستخدمهم إمتى وإزاي عشان يساعدوك في رحلة تعلّمك، من غير ما تبقى معتمد عليهم بدل الفهم.</p>

<div class="progress-bar-wrap"><div class="progress-bar" style="width: <?= $percent ?>%"></div></div>
<div class="progress-label"><?= $done ?> / <?= $total ?> أدوات خلّصتها (<?= $percent ?>%)</div>
