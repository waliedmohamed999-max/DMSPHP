...
$page_title = 'Full Stack Developer — لوحة الدروس';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار Full Stack Developer</h1>
<p class="subtitle">المسار التعليمي الكامل لوظيفة الـ Full Stack بلغة PHP + MySQL — Front-End وBack-End في رحلة واحدة متكاملة. بعض المراحل هتاخدك مباشرة لمسارات Front-End أو PHP Back-End الجاهزة عندنا، وبعضها مراحل خاصة بالمسار ده بس.</p>
