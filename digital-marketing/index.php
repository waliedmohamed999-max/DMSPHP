...
$page_title = 'التسويق الإلكتروني — لوحة الدروس';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار التسويق الإلكتروني</h1>
<p class="subtitle"><span class="ltr">Digital Marketing</span> — من فهم القنوات الأساسية لبناء خطة تسويق حقيقية: SEO، محتوى، سوشيال ميديا، إعلانات مدفوعة، وتحليلات.</p>
