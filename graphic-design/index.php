...
$page_title = 'التصميم الجرافيكي — لوحة الدروس';
$base = '.';
include __DIR__ . '/includes/header.php';
?>

<h1>مسار التصميم الجرافيكي</h1>
<p class="subtitle"><span class="ltr">Graphic Design</span> — من عناصر التصميم الأساسية والألوان والطباعة، لأدوات الاحتراف، وصولاً لبناء هوية بصرية كاملة لعلامة تجارية.</p>
